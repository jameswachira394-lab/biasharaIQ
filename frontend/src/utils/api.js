...
const API_URL = (process.env.NEXT_PUBLIC_API_URL || 'https://biasharaiq.onrender.com').trim() || 'https://biasharaiq.onrender.com'
...
export const authApi = {
  ...
  resetPassword: (token, email, new_password) =>
    api.post('/auth/reset-password', { token, email, new_password }),
}

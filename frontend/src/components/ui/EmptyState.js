...
export default function EmptyState({
  ...
  return (
    <div className={clsx('flex flex-col items-center justify-center py-16 text-center px-4', className)}>
      ...
      <h3 className="font-display font-semibold text-semantic-white mb-1">{title}</h3>
      {description && <p className="text-semantic-textSecondary text-sm max-w-sm">{description}</p>}
